...
- Bot的匹配规则对非中文语言几乎无效，但Bot的验证问题支持英文，你可以使用`/set_ui_locale`指令来修改验证问题显示语言
...
- `/set_ui_locale`：设置验证问题的显示语言，目前仅支持英文/中文，需要跟一个参数来表示要设置的语言，支持的参数有 `en` `EN` 表示英文，`zh` `ZH` 表示中文，使用示例：
  - `/set_ui_locale@tg_1021_bot en`：设置验证问题的显示语言为**英文**
  - `/set_ui_locale@tg_1021_bot ZH`：设置验证问题的显示语言为**中文**
